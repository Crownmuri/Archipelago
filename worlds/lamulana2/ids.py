...
class ItemID(IntEnum):
    ...
    RoseandCamelia = 95
    SpaceCapstarII = 96
    LonelyHouseMoving = 97
    MekuriMaster = 98
    BounceShot = 99
    MiracleWitch = 100
    FutureDevelopmentCompany = 101
    LaMulana = 102
    LaMulana2 = 103
    SacredOrb0 = 104
    SacredOrb1 = 105
    ...
    Research9 = 173
    Research10 = 174
    ProgressiveBeherit1 = 175
    ProgressiveBeherit2 = 176
    ProgressiveBeherit3 = 177
    ProgressiveBeherit4 = 178
    ProgressiveBeherit5 = 179
    ProgressiveBeherit6 = 180
    ProgressiveBeherit7 = 181
    ShurikenAmmo = 182
    RollingShurikenAmmo = 183
    EarthSpearAmmo = 184
    FlareAmmo = 185
    BombAmmo = 186
    ChakramAmmo = 187
...
class LocationID(IntEnum):
    ...
    # Auto-Incremented
    HeavenMantraMural = 157
    EarthMantraMural = 158
    SunMantraMural = 159
    MoonMantraMural = 160
    SeaMantraMural = 161
    FireMantraMural = 162
    WindMantraMural = 163
    MotherMantraMural = 164
    ChildMantraMural = 165
    NightMantraMural = 166

    ResearchAnnwfn = 167
    ResearchIT = 168
    ResearchIBTopLeft = 169
    ResearchIBTopRight = 170
    ResearchIBLeft = 171
    ResearchIBPit = 172
    ResearchIBTent1 = 173
    ResearchIBTent2 = 174
    ...
    DissonanceValhalla = 177
    DissonanceDSLM = 178
    DissonanceHL = 179
    DissonanceEPG = 180
    DissonanceNibiru = 181
    DissonanceMoG = 182
    ...
    MinoShop2 = 218
    MinoShop3 = 219
    BargainDuckShop1 = 220
    BargainDuckShop2 = 221
    BargainDuckShop3 = 222
    VenumShop1 = 223
    VenumShop2 = 224
    VenumShop3 = 225
    PeibalusaShop1 = 226
    PeibalusaShop2 = 227
    PeibalusaShop3 = 228
    HiroRoderickShop1 = 229
    HiroRoderickShop2 = 230
    HiroRoderickShop3 = 231
    HydlitShop1 = 232
    HydlitShop2 = 233
    HydlitShop3 = 234
    AytumShop1 = 235
    ...
    # -------------------------------------------------------------------------
    # Puzzles and Passages (no checks)
    # -------------------------------------------------------------------------
    
    AnnwfnRightShortcut = 303
    IBLeftShortcut = 304
    HoMLadder = 305
    Bergelmir = 306
    WhitePedestals = 307
...
class AreaID(IntEnum):
    ...
    InfernoCavern = 4
    GateofGuidance = 5
    GateofGuidanceLeft = 6
    MausoleumofGiants = 7
    MausoleumofGiantsRubble = 8
    EndlessCorridor = 9
    GateofIllusion = 10
    RoY = 11
    RoYTopLeft = 12
...
AP_LOCATION_NAMES = {
    ...
    "[AC C-6] Venum Shop 1": LocationID.VenumShop1,
    "[AC C-6] Venum Shop 2": LocationID.VenumShop2,
    "[AC C-6] Venum Shop 3": LocationID.VenumShop3,
    "[AC D-1] Anu Reward": LocationID.ScripturesChest,
    "[AC D-2] Anzu Reward": LocationID.DestinyTabletChest,
    "[AC D-5] Wind Mantra Mural": LocationID.WindMantraMural,
    "[ALTAR] Secret Treasure of Life Location": LocationID.SecretTreasureofLifeItem,
    "[ANN B-5] Submerged Chest (S2)": LocationID.CrystalSkullChestAnnwfn,
    "[ANN C-1] Annwfn Weapon Vault": LocationID.RollingShurikenPuzzleReward,
    "[ANN C-2] Annwfn Research Papers": LocationID.ResearchAnnwfn,
    "[ANN C-4] Look Away Chest": LocationID.GloveChest,
    "[ANN D-4] Earth Mantra Mural (S2)": LocationID.EarthMantraMural,
    "[ANN E-1] Pym Shop 1": LocationID.PymShop1,
    "[ANN E-1] Pym Shop 2": LocationID.PymShop2,
    "[ANN E-1] Pym Shop 3": LocationID.PymShop3,
    "[ANN E-3] Map Chest": LocationID.MapChestAnnwfn,
    "[ANN E-5] Hidden Chest & Sigil (S3)": LocationID.SacredOrbChestAnnwfn,
    "[ANN F-2] Kujata Reward": LocationID.DjedPillarChest,
    "[ANN F-5] Mimir Weapon Vault": LocationID.SilverShieldPuzzleReward,
    "[CAVERN] Sun Mantra Mural": LocationID.SunMantraMural,
    "[DF A-4] 5 Weights Chest": LocationID.SacredOrbChestDF,
    "[DF A-4] Ankh Chest (S1)": LocationID.AnkhChestDF,
    "[DF B-5] Shuhoka Shop 1 (S2)": LocationID.ShuhokaShop1,
    "[DF B-5] Shuhoka Shop 2 (S2)": LocationID.ShuhokaShop2,
    "[DF B-5] Shuhoka Shop 3 (S2)": LocationID.ShuhokaShop3,
    "[DF C-2] Breakable Push Block Chest": LocationID.DeathVillageChest,
    "[DF D-3] Frey's Ship": LocationID.FreyShip,
    "[DF D-4] Map Chest": LocationID.MapChestDF,
    "[DF D-5] Heaven Mantra Mural": LocationID.HeavenMantraMural,
    "[DF E-3] Hugin & Munin Reward": LocationID.OriginSigilChest,
    "[DSLM A-4] Destroy the False Tablet": LocationID.FeatherChest,
    "[DSLM A-4] DSLM Research Papers": LocationID.ResearchDSLM,
    "[DSLM B-1] Ammit Reward": LocationID.VesselChest,
    "[DSLM B-3] Use Crystal Skull Chest": LocationID.CrystalSkullChestDLM,
    "[DSLM B-7] Zero Weight Scale Chest": LocationID.MaatsFeatherChest,
    "[DSLM C-2] Kero Shop 1": LocationID.KeroShop1,
    "[DSLM C-2] Kero Shop 2": LocationID.KeroShop2,
    "[DSLM C-2] Kero Shop 3": LocationID.KeroShop3,
    "[DSLM C-3] Bombable Wall Chest": LocationID.LaMulanaChest,
    "[DSLM C-6] Map Chest (S2)": LocationID.MapChestDLM,
    "[DSLM C-8] Aten-Ra Reward": LocationID.CrucifixChest,
    ...
    "[EPD C-2] Spaulder Key Fairy Chest": LocationID.SpaulderChest,
    "[EPD C-3] Ajisukitakahikone Reward (S3)": LocationID.DeathSigilChest,
    "[EPD E-5] Anubis Trials": LocationID.OsirisItem,
    "[EPD D-4] Top-Left Mjolnir Switch Chest": LocationID.LaMulana2Chest,
    "[EPD D-5] Map Chest": LocationID.MapChestEPD,
    "[EPG A-5] Ratatoskr 4 Reward": LocationID.AnkhJewel,
    "[EPG C-5] Mother Mantra Mural": LocationID.MotherMantraMural,
    "[EPG C-6] Key-locked Weapon Vault (S3)": LocationID.BombPuzzleReward,
    "[EPG E-2] Map Chest (S3)": LocationID.MapChestEPG,
    "[EPG E-7] Beo Eg-Lana Mural": LocationID.BeoEglanaMural,
    "[GOG B-4] Hidden Item Spot": LocationID.BronzeMirrorSpot,
    "[GOG B-4] Hiner Shop 1": LocationID.HinerShop1,
    "[GOG B-4] Hiner Shop 2": LocationID.HinerShop2,
    "[GOG B-4] Hiner Shop 3": LocationID.HinerShop3,
    "[GOG B-4] Hiner Shop 4 (3 Guardians)": LocationID.HinerShop4,
    "[GOG B-4] Holy Grail Chest": LocationID.HolyGrailChest,
    "[GOG D-2] Shell Horn Chest": LocationID.ShellHornChest,
    "[GOI C-3] Fobos' Skull Check": LocationID.FobosItem2,
    "[GOI C-3] Fobos' Inspiration": LocationID.FobosItem,
    "[GOTD B-2] GotD Weapon Vault (S3)": LocationID.KatanaPuzzleReward,
    "[GOTD B-3] Aytum Shop 1": LocationID.AytumShop1,
    "[GOTD B-3] Aytum Shop 2": LocationID.AytumShop2,
    "[GOTD B-3] Aytum Shop 3": LocationID.AytumShop3,
    "[GOTD B-4] Mirrored Dais & Chest": LocationID.SacredOrbChestGotD,
    "[GOTD B-6] Dwarves' Missing Block Chest": LocationID.AnchorChest,
    "[GOTD C-7] Laser Beams Chest": LocationID.VajraChest,
    "[GOTD D-3] Map Chest": LocationID.MapChestGotD,
    "[GOTD E-3] Flipped Push Block Chest": LocationID.YagooMapStreetChest,
    "[GOTD F-3] Flipped Crusher Chest": LocationID.CrystalSkullChestGotD,
    "[HL A-2] Hidden Dais Chest": LocationID.CrystalSkullChestHL,
    "[HL A-3] Megarock Shop 1": LocationID.MegarockShop1,
    "[HL A-3] Megarock Shop 2": LocationID.MegarockShop2,
    "[HL A-3] Megarock Shop 3": LocationID.MegarockShop3,
    "[HL A-5] Battery Chest": LocationID.CogofAntiquityChest,
    "[HL B-1] Heaven's Labyrinth Weapon Vault": LocationID.AxePuzzleReward,
    "[HL C-2] Middle Top Chest": LocationID.SacredOrbChestHL,
    "[HL C-4] Typhon's Dissonance": LocationID.DissonanceHL,
    ...
    "[HOM F-3] Chest Behind Ladon (S4)": LocationID.CrystalSkullChestHoM,
    "[HOM G-4] Fairylan Shop 1": LocationID.FairylanShop1,
    "[HOM G-4] Fairylan Shop 2": LocationID.FairylanShop2,
    "[HOM G-4] Fairylan Shop 3": LocationID.FairylanShop3,
    "[IB A-6] IB Research - Left Chamber": LocationID.ResearchIBLeft,
    "[IB B-2] Fake Wall Chest": LocationID.GaleFibulaChest,
    "[IB B-4] Time Altar Chest (S3)": LocationID.LampofTimeChest,
    "[IB C-1] Top-Left Weapon Vault": LocationID.EarthSpearPuzzleReward,
    "[IB C-3] Ratatoskr 2 Reward": LocationID.CrystalSkullIB,
    "[IB C-5] IB Research - Pit of Time": LocationID.ResearchIBPit,
    "[IB C-6] Lava Weapon Vault": LocationID.ChainWhipPuzzleReward,
    "[IB D-1] IB Research - Top Left": LocationID.ResearchIBTopLeft,
    "[IB D-2] Top Dash Chest (S2)": LocationID.TotemPoleChest,
    "[IB E-1] Peibalusa Shop 1": LocationID.PeibalusaShop1,
    "[IB E-1] Peibalusa Shop 2": LocationID.PeibalusaShop2,
    "[IB E-1] Peibalusa Shop 3": LocationID.PeibalusaShop3,
    "[IB E-3] IB Research - Tent (7 Guardians)": LocationID.ResearchIBTent2,
    "[IB E-3] IB Research - Tent (First Time)": LocationID.ResearchIBTent1,
    "[IB E-3] IB Research - Tent (Post Heimdall)": LocationID.ResearchIBTent3,
    "[IB E-5] Jormungand Reward": LocationID.MjolnirChest,
    "[IB E-7] Moon Mantra Mural (S3)": LocationID.MoonMantraMural,
    "[IB F-2] Map Chest": LocationID.MapChestIB,
    "[IB F-6] Submerged Sigil Chest (S2)": LocationID.SacredOrbChestIB,
    "[IB G-1] IB Research - Top Right": LocationID.ResearchIBTopRight,
    "[IB G-3] Mulbruk's Item (4 Guardians)": LocationID.MulbrukItem,
    "[IB G-5] Hidden Sigil Chest (S3)": LocationID.IceCloakChest,
    "[IB G-6] Hiro Roderick Shop 1": LocationID.HiroRoderickShop1,
    "[IB G-6] Hiro Roderick Shop 2": LocationID.HiroRoderickShop2,
    "[IB G-6] Hiro Roderick Shop 3": LocationID.HiroRoderickShop3,
    "[IB H-7] Buried Fortress Chest (S3)": LocationID.BatteryChest,
    "[IB I-6] Pressure Plate Weapon Vault (S3)": LocationID.ChakramPuzzleReward,
    "[IB I-7] Dinosaur Figure Chest": LocationID.DinosaurFigureChest,
    "[IC A-1] Child Mantra Mural": LocationID.ChildMantraMural,
    "[IT A-1] BTK Shop 1": LocationID.BTKShop1,
    "[IT A-1] BTK Shop 2": LocationID.BTKShop2,
    "[IT A-1] BTK Shop 3": LocationID.BTKShop3,
    "[IT A-2] Arrow Trap Chest (S2)": LocationID.LifeSigilChest,
    "[IT B-2] Map Chest": LocationID.MapChestIT,
    "[IT B-4] Vedfolnir Reward": LocationID.AnkhChestIT,
    "[IT C-2] Surtr Reward": LocationID.FlameTorcChest,
    ...
    "[IT G-2] Ratatoskr 3 Reward": LocationID.CrystalSkullChestIT,
    "[MOG E-4] Sakit's Dissonance": LocationID.DissonanceMoG,
    "[NIBIRU] Nibiru's Dissonance": LocationID.DissonanceNibiru,
    "[NIBIRU] Night Mantra Mural (S4)": LocationID.NightMantraMural,
    "[RANDO] Starting Shop 1": LocationID.StartingShop1,
    "[RANDO] Starting Shop 2": LocationID.StartingShop2,
    "[RANDO] Starting Shop 3": LocationID.StartingShop3,
    "[ROY B-2] Knife Weapon Vault (S1)": LocationID.KnifePuzzleReward,
    "[ROY B-3] Ankh Chest": LocationID.AnkhChestRoY,
    "[ROY C-3] Shuriken Weapon Vault": LocationID.ShurikenPuzzleReward,
    "[ROY C-5] Korobock Shop 1": LocationID.KorobockShop1,
    "[ROY C-5] Korobock Shop 2": LocationID.KorobockShop2,
    "[ROY C-5] Korobock Shop 3": LocationID.KorobockShop3,
    "[ROY D-2] Mantra Software Mural": LocationID.MantraMural,
    ...
    "[SFG A-5] Hydlit Shop 3": LocationID.HydlitShop3,
    "[SFG B-5] Rapier Weapon Vault": LocationID.RapierPuzzleReward,
    "[SFG B-6] 3 Timed Weights Chest": LocationID.AnkhChestSotFG,
    "[SFG C-2] Mimic Chest Mimic": LocationID.SacredOrbChestSotFG,
    "[SFG C-3] Sea Mantra Mural (S2)": LocationID.SeaMantraMural,
    "[SFG D-1] Balor Reward (S3)": LocationID.ClaydollChest,
    "[SFG D-5] Map Chest": LocationID.MapChestSotFG,
    "[SFG E-3] Badhbh Cath Reward (S3)": LocationID.PochetteKeyChest,
    "[SFG E-7] 7 Dais Chest (S1)": LocationID.BirthSigilChest,
    "[TS A-2] Belial Reward": LocationID.PowerBandChest,
    "[TS B-4] Key Fairy Chest (S3)": LocationID.RingChest,
    "[TS C-4] Ash Geen Shop 1": LocationID.AshGeenShop1,
    "[TS C-4] Ash Geen Shop 2": LocationID.AshGeenShop2,
    "[TS C-4] Ash Geen Shop 3": LocationID.AshGeenShop3,
    "[TS C-6] 4 Moving Platforms Chest (S3)": LocationID.CrystalSkullChestTS,
    "[TS D-2] Map Chest": LocationID.MapChestTS,
    "[TS D-5] Falling Platform Chest": LocationID.SacredOrbChestTS,
    "[TS E-6] Daji Reward": LocationID.EggofCreationChest,
    "[TS F-3] Flare Gun Weapon Vault (S2)": LocationID.FlarePuzzleReward,
    "[VAL A-3] Map Chest (S1)": LocationID.MapChestValhalla,
    "[VAL B-5] Jalandhara's Treasure (S3&4)": LocationID.CrystalSkullChestValhalla,
    "[VAL C-4] Crawling Weapon Vault": LocationID.CaltropPuzzleReward,
    "[VAL D-1] Fire Mantra Mural (S2)": LocationID.FireMantraMural,
    "[VAL D-2] 4 Sigil Weapon Vault": LocationID.FlailWhipPuzzleReward,
    "[VAL D-4] Bargain Duck Shop 1": LocationID.BargainDuckShop1,
    "[VAL D-4] Bargain Duck Shop 2": LocationID.BargainDuckShop2,
    "[VAL D-4] Bargain Duck Shop 3": LocationID.BargainDuckShop3,
    "[VAL E-2] Vritra Reward (S1)": LocationID.ScalesphereChest,
    "[VAL E-3] Vritra's Dissonance (S1)": LocationID.DissonanceValhalla,
    "[VOD B-3] Alsedana's Item (Vritra)": LocationID.AlsedanaItem,
    "[VOD B-3] Alsedana's Funeral (6 Guardians)": LocationID.GiltoriyoItem,
    "[VOD C-4] Nebur Shop 1": LocationID.NeburShop1,
    "[VOD C-4] Nebur Shop 2": LocationID.NeburShop2,
    "[VOD C-4] Nebur Shop 3": LocationID.NeburShop3,
    "[VOD D-4] Xelpud's Item": LocationID.XelpudItem,
    "[VOD E-4] Modro Shop 1": LocationID.ModroShop1,
    "[VOD E-4] Modro Shop 2": LocationID.ModroShop2,
    "[VOD E-4] Modro Shop 3": LocationID.ModroShop3,
    "[VOD E-4] Nebur's Item": LocationID.NeburItem,
    ...
    "[DF D-4] Hermod's Coin Pot": LocationID.field05D3,
    "[DF E-4] Pre-Hugin and Munin Weight Pot": LocationID.field05E3,
    "[DF A-3] Dwarves' Hideout Lower Right Pot": LocationID.field05A2_2,
    "[DF A-3] Dwarves' Hideout Upper Right Pot": LocationID.field05A2_1,
    ...
    "[GOTD B-6] Dwarves' Missing Block Item Pot": LocationID.field07B5,
    ...
    "[GOTD F-5] Wedjet Gate Single Upper Item Pot": LocationID.field07F4,
    "[GOTD F-5] Wedjet Gate Single Lower Item Pot": LocationID.field07F4f,
    ...
    "[TS D-7] Stacked Item Pot": LocationID.field08D6f,
    "[TS D-7] Upper Corridor Coin Pot": LocationID.field08D6g,
    ...
    "[HL B-1] Baphomet's Item Pot": LocationID.field09B0,
    ...
    "[DSLM C-4] Ladder to Atum Lower Item Pot": LocationID.field11B3,
    "[DSLM C-4] Ladder to Atum Upper Item Pot": LocationID.field11C3,
    ...
    "[DSLM D-7] Entrance Gate Coin Pot": LocationID.field11D6g,
    "[DSLM D-7] Entrance Gate Item Pot": LocationID.field11D6,
    ...
    "[EPG C-6] Weapon Vault Upper Item Pot": LocationID.field14C5b,
    "[EPG C-6] Weapon Vault Lower Item Pot": LocationID.field14C5,
    "[EPG C-7] Software Mural Left Item Pot": LocationID.field14C6b,
    "[EPG C-7] Software Mural Right Item Pot": LocationID.field14C6,
    ...
    "[EPD A-4] Maze Clear Left Item Pot": LocationID.field15A3,
    "[EPD A-4] Maze Clear Right Item Pot": LocationID.field15A3b,
    ...
    "[SFG D-7] Glossary in Flame Torc Wall Above Spikes (Scan)": LocationID.Glossary081,
...
ITEM_MAP = {
    ...
    "Djed Pillar": ItemID.DjedPillar,
    "Mjolnir": ItemID.Mjolnir,
    "Progressive Beherit": ItemID.ProgressiveBeherit1,
    "Ancient Battery": ItemID.AncientBattery,
    "Lamp of Time": ItemID.LampofTime,
    "Pochette Key": ItemID.PochetteKey,
    "Pyramid Crystal": ItemID.PyramidCrystal,
    ...
    "Vajra": ItemID.Vajra,
    "Power Band": ItemID.PowerBand,
    "Bronze Mirror": ItemID.BronzeMirror,
    "Perfume": ItemID.Perfume,
    "Ice Cloak": ItemID.IceCloak,
    "Nemean Fur": ItemID.NemeanFur,
    "Gauntlet": ItemID.Gauntlet,
    "Anchor": ItemID.Anchor,
    "Freya's Pendant": ItemID.FreyasPendant,
    "Totem Pole": ItemID.TotemPole,
    "Grapple Claw": ItemID.GrappleClaw,
    "Spaulder": ItemID.Spaulder,
    "Scalesphere": ItemID.Scalesphere,
    "Crucifix": ItemID.Crucifix,
    "Ganesha's Talisman": ItemID.GaneshaTalisman,
    "Maat's Feather": ItemID.MaatsFeather,
    "Ring": ItemID.Ring,
    "Bracelet": ItemID.Bracelet,
    "Feather": ItemID.Feather,
    "Scriptures": ItemID.Scriptures,
    "Frey's Ship": ItemID.FreysShip,
    "Codices": ItemID.Codices,
    "Snow Shoes": ItemID.SnowShoes,
    "Harp": ItemID.Harp,
    "Book of the Dead": ItemID.BookoftheDead,
    "Light Scythe": ItemID.LightScythe,
    "Destiny Tablet": ItemID.DestinyTablet,
    "Secret Treasure of Life": ItemID.SecretTreasureofLife,
    "Origin Sigil": ItemID.OriginSigil,
    "Birth Sigil": ItemID.BirthSigil,
    ...
    "Progressive Shield": ItemID.Shield1,
    "Xelputter": ItemID.Xelputter,
    ...
    "Bounce Shot": ItemID.BounceShot,
    "Miracle Witch": ItemID.MiracleWitch,
    "Future Development Company": ItemID.FutureDevelopmentCompany,
    "La-Mulana": ItemID.LaMulana,
    "La-Mulana 2": ItemID.LaMulana2,
    "Heaven": ItemID.Heaven,
    "Earth": ItemID.Earth,
    "Sun": ItemID.Sun,
    "Moon": ItemID.Moon,
    "Sea": ItemID.Sea,
    ...
    "Pistol Ammo": ItemID.PistolAmmo,
    "Weights": ItemID.Weights,
    "Ankh Jewel (Fafnir)": ItemID.AnkhJewel1,
    "Ankh Jewel (Vritra)": ItemID.AnkhJewel2,
    "Ankh Jewel (Kujata)": ItemID.AnkhJewel3,
    "Ankh Jewel (Aten-Ra)": ItemID.AnkhJewel4,
    "Ankh Jewel (Jormungand)": ItemID.AnkhJewel5,
    "Ankh Jewel (Anu)": ItemID.AnkhJewel6,
    ...
    "Map (Icefire Treetop)": ItemID.Map4,
    "Map (Divine Fortress)": ItemID.Map5,
    "Map (Shrine of the Frost Giants)": ItemID.Map6,
    "Map (Gate of the Dead)": ItemID.Map7,
    "Map (Takamagahara Shrine)": ItemID.Map8,
    "Map (Heaven's Labyrinth)": ItemID.Map9,
    "Map (Valhalla)": ItemID.Map10,
    "Map (Dark Star Lord's Mausoleum)": ItemID.Map11,
    "Map (Ancient Chaos)": ItemID.Map12,
    "Map (Hall of Malice)": ItemID.Map13,
    "Map (Eternal Prison - Gloom)": ItemID.Map14,
    "Map (Eternal Prison - Doom)": ItemID.Map15,
    "Map (Village of Departure)": ItemID.Map16,
#    "Map #17": ItemID.Map17,
#    "Map #18": ItemID.Map18,
#    "Map #19": ItemID.Map19,
#    "Map #20": ItemID.Map20,
    "Kosugi Research FILE 01": ItemID.Research1,
    "Kosugi Research FILE 02": ItemID.Research2,
    "Kosugi Research FILE 03": ItemID.Research3,
    "Kosugi Research FILE 04": ItemID.Research4,
    "Kosugi Research FILE 05": ItemID.Research5,
    "Kosugi Research FILE 06": ItemID.Research6,
    "Kosugi Research FILE 07": ItemID.Research7,
    "Kosugi Research FILE 08": ItemID.Research8,
    "Kosugi Research FILE 09": ItemID.Research9,
    "Kosugi Research FILE 10": ItemID.Research10,
#    "Progressive Beherit": ItemID.ProgressiveBeherit2,
#    "Progressive Beherit": ItemID.ProgressiveBeherit3,
#    "Progressive Beherit": ItemID.ProgressiveBeherit4,
#    "Progressive Beherit": ItemID.ProgressiveBeherit5,
#    "Progressive Beherit": ItemID.ProgressiveBeherit6,
#    "Progressive Beherit": ItemID.ProgressiveBeherit7,
#    "Progressive Whip": ItemID.Whip2,
#    "Progressive Whip": ItemID.Whip3,
#    "Progressive Shield": ItemID.Shield2,
#    "Progressive Shield": ItemID.Shield3,

}

ORIGINAL_SHOPS = {
    LocationID.NeburShop1: (ItemID.Weights, 10),
    LocationID.NeburShop2: (ItemID.YagooMapReader, 10),
    LocationID.NeburShop3: (ItemID.TextTrax, 10),

    LocationID.ModroShop1: (ItemID.Shield1, 5),
    LocationID.ModroShop2: (ItemID.Pistol, 5),
    LocationID.ModroShop3: (ItemID.PistolAmmo, 10),

    LocationID.SidroShop1: (ItemID.HandScanner, 5),
    LocationID.SidroShop2: (ItemID.ShurikenAmmo, 10),
    LocationID.SidroShop3: (ItemID.Pepper, 5),

    LocationID.HinerShop1: (ItemID.Weights, 10),
    LocationID.HinerShop2: (ItemID.Codices, 10),
    LocationID.HinerShop3: (ItemID.AnkhJewel1, 5),
    LocationID.HinerShop4: (ItemID.AnkhJewel8, 10),

    LocationID.KorobockShop1: (ItemID.Weights, 10),
    LocationID.KorobockShop2: (ItemID.ShurikenAmmo, 10),
    LocationID.KorobockShop3: (ItemID.Guild, 10),

    LocationID.ShuhokaShop1: (ItemID.Weights, 10),
    LocationID.ShuhokaShop2: (ItemID.ShurikenAmmo, 10),
    LocationID.ShuhokaShop3: (ItemID.Alert, 10),

    LocationID.PymShop1: (ItemID.Weights, 10),
    LocationID.PymShop2: (ItemID.RollingShurikenAmmo, 10),
    LocationID.PymShop3: (ItemID.Snapshot, 10),

    LocationID.BTKShop1: (ItemID.Weights, 10),
    LocationID.BTKShop2: (ItemID.CaltropsAmmo, 10),
    LocationID.BTKShop3: (ItemID.EngaMusica, 7),

    LocationID.MinoShop1: (ItemID.Weights, 10),
    LocationID.MinoShop2: (ItemID.BombAmmo, 10),
    LocationID.MinoShop3: (ItemID.LonelyHouseMoving, 10),

    LocationID.BargainDuckShop1: (ItemID.Weights, 10),
    LocationID.BargainDuckShop2: (ItemID.CaltropsAmmo, 10),
    LocationID.BargainDuckShop3: (ItemID.FutureDevelopmentCompany, 9),

    LocationID.PeibalusaShop1: (ItemID.Weights, 10),
    LocationID.PeibalusaShop2: (ItemID.EarthSpearAmmo, 10),
    LocationID.PeibalusaShop3: (ItemID.RaceScanner, 10),

    LocationID.HiroRoderickShop1: (ItemID.Weights, 10),
    LocationID.HiroRoderickShop2: (ItemID.FlareAmmo, 10),
    LocationID.HiroRoderickShop3: (ItemID.Harp, 10),

    LocationID.HydlitShop1: (ItemID.Weights, 10),
    LocationID.HydlitShop2: (ItemID.BombAmmo, 10),
    LocationID.HydlitShop3: (ItemID.GaneshaTalisman, 10),

    LocationID.AytumShop1: (ItemID.Weights, 10),
    LocationID.AytumShop2: (ItemID.ShurikenAmmo, 10),
    LocationID.AytumShop3: (ItemID.BounceShot, 10),

    LocationID.KeroShop1: (ItemID.Weights, 10),
    LocationID.KeroShop2: (ItemID.PistolAmmo, 10),
    LocationID.KeroShop3: (ItemID.RoseandCamelia, 10),

    LocationID.AshGeenShop1: (ItemID.Weights, 10),
    LocationID.AshGeenShop2: (ItemID.FlareAmmo, 10),
    LocationID.AshGeenShop3: (ItemID.MekuriMaster, 10),

    LocationID.VenumShop1: (ItemID.Weights, 10),
    LocationID.VenumShop2: (ItemID.CaltropsAmmo, 10),
    LocationID.VenumShop3: (ItemID.SpaceCapstarII, 10),

    LocationID.MegarockShop1: (ItemID.Weights, 10),
    LocationID.MegarockShop2: (ItemID.EarthSpearAmmo, 10),
    LocationID.MegarockShop3: (ItemID.Bracelet, 10),

    LocationID.FairylanShop1: (ItemID.Weights, 10),
    LocationID.FairylanShop2: (ItemID.ChakramAmmo, 10),
    LocationID.FairylanShop3: (ItemID.Shield3, 10),
}

SHOP_WRITE_ORDER = [
    LocationID.NeburShop1,
    LocationID.NeburShop2,
    LocationID.NeburShop3,

    LocationID.ModroShop1,
    LocationID.ModroShop2,
    LocationID.ModroShop3,

    LocationID.SidroShop1,
    LocationID.SidroShop2,
    LocationID.SidroShop3,

    LocationID.HinerShop1,
    LocationID.HinerShop2,
    LocationID.HinerShop3,
    LocationID.HinerShop4,

    LocationID.KorobockShop1,
    LocationID.KorobockShop2,
    LocationID.KorobockShop3,

    LocationID.PymShop1,
    LocationID.PymShop2,
    LocationID.PymShop3,

    LocationID.PeibalusaShop1,
    LocationID.PeibalusaShop2,
    LocationID.PeibalusaShop3,

    LocationID.HiroRoderickShop1,
    LocationID.HiroRoderickShop2,
    LocationID.HiroRoderickShop3,

    LocationID.MinoShop1,
    LocationID.MinoShop2,
    LocationID.MinoShop3,

    LocationID.BTKShop1,
    LocationID.BTKShop2,
    LocationID.BTKShop3,

    LocationID.ShuhokaShop1, 
    LocationID.ShuhokaShop2, 
    LocationID.ShuhokaShop3, 

    LocationID.HydlitShop1,
    LocationID.HydlitShop2,
    LocationID.HydlitShop3,

    LocationID.AytumShop1,
    LocationID.AytumShop2,
    LocationID.AytumShop3,


    LocationID.AshGeenShop1,
    LocationID.AshGeenShop2,
    LocationID.AshGeenShop3,

    LocationID.MegarockShop1,
    LocationID.MegarockShop2,
    LocationID.MegarockShop3,

    LocationID.BargainDuckShop1,
    LocationID.BargainDuckShop2,
    LocationID.BargainDuckShop3,

    LocationID.KeroShop1,
    LocationID.KeroShop2,
    LocationID.KeroShop3,

    LocationID.VenumShop1,
    LocationID.VenumShop2,
    LocationID.VenumShop3,

    LocationID.FairylanShop1,
    LocationID.FairylanShop2,
    LocationID.FairylanShop3,

    LocationID.StartingShop1,
    LocationID.StartingShop2,
    LocationID.StartingShop3,
]

STARTING_ITEM_OPTION_MAP = {
    "random_grail": ItemID.HolyGrail,
    "random_scanner": ItemID.HandScanner,
    "random_codices": ItemID.Codices,
    "random_fdc": ItemID.FutureDevelopmentCompany,
    "random_ring": ItemID.Ring,
    "random_shell_horn": ItemID.ShellHorn,
}
...
MAP_ITEMS = [
    ItemID.Map1, ItemID.Map2, ItemID.Map3, ItemID.Map4,
    ItemID.Map5, ItemID.Map6, ItemID.Map7, ItemID.Map8,
    ItemID.Map9, ItemID.Map10, ItemID.Map11, ItemID.Map12,
    ItemID.Map13, ItemID.Map14, ItemID.Map15, ItemID.Map16,
#    ItemID.Map17, ItemID.Map18, ItemID.Map19, ItemID.Map20,
#    UNUSED MAPS
]

DISSONANCE_IDS = {
    LocationID.DissonanceValhalla,
    LocationID.DissonanceDSLM,
    LocationID.DissonanceHL,
    LocationID.DissonanceEPG,
    LocationID.DissonanceNibiru,
    LocationID.DissonanceMoG,
}
...
MANTRA_LOCATIONS = {
    LocationID.HeavenMantraMural: ItemID.Heaven,
    LocationID.EarthMantraMural: ItemID.Earth,
    LocationID.SunMantraMural: ItemID.Sun,
    LocationID.MoonMantraMural: ItemID.Moon,
    LocationID.SeaMantraMural: ItemID.Sea,
    LocationID.FireMantraMural: ItemID.Fire,
    LocationID.WindMantraMural: ItemID.Wind,
    LocationID.MotherMantraMural: ItemID.Mother,
    LocationID.ChildMantraMural: ItemID.Child,
    LocationID.NightMantraMural: ItemID.Night,
}
...
SHOP_ITEM_IDS = {
    ItemID.ShurikenAmmo,
    ItemID.RollingShurikenAmmo,
    ItemID.EarthSpearAmmo,
    ItemID.FlareAmmo,
    ItemID.BombAmmo,
    ItemID.ChakramAmmo,
    ItemID.CaltropsAmmo,
...
# seed.lm2r allowed locations (other locations go to seed.lm2ap)
LEGACY_LOCATION_IDS = frozenset({
    LocationID.DjedPillarChest, LocationID.MjolnirChest, LocationID.BatteryChest, LocationID.LampofTimeChest, LocationID.PochetteKeyChest, LocationID.PyramidCrystalChest,
    LocationID.VesselChest, LocationID.EggofCreationChest, LocationID.GiantsFluteChest, LocationID.CogofAntiquityChest, LocationID.MobileSuperX3Item, LocationID.ShellHornChest,
    LocationID.HolyGrailChest, LocationID.FairyGuildPassChest, LocationID.GloveChest, LocationID.DinosaurFigureChest, LocationID.GaleFibulaChest, LocationID.FlameTorcChest,
    LocationID.VajraChest, LocationID.PowerBandChest, LocationID.BronzeMirrorSpot, LocationID.PerfumeChest, LocationID.IceCloakChest, LocationID.NemeanFurChest,
    LocationID.GauntletChest, LocationID.AnchorChest, LocationID.TotemPoleChest, LocationID.GrappleClawChest, LocationID.SpaulderChest, LocationID.ScalesphereChest,
    LocationID.CrucifixChest, LocationID.MaatsFeatherChest, LocationID.RingChest, LocationID.FeatherChest, LocationID.ScripturesChest, LocationID.FreyShip,
    LocationID.BookoftheDeadChest, LocationID.DestinyTabletChest, LocationID.SecretTreasureofLifeItem, LocationID.OriginSigilChest, LocationID.BirthSigilChest, LocationID.LifeSigilChest,
    LocationID.DeathSigilChest, LocationID.ClaydollChest, LocationID.KnifePuzzleReward, LocationID.RapierPuzzleReward, LocationID.AxePuzzleReward, LocationID.KatanaPuzzleReward,
    LocationID.ShurikenPuzzleReward, LocationID.RollingShurikenPuzzleReward, LocationID.EarthSpearPuzzleReward, LocationID.FlarePuzzleReward, LocationID.BombPuzzleReward, LocationID.ChakramPuzzleReward,
    LocationID.CaltropPuzzleReward, LocationID.YagooMapStreetChest, LocationID.MantraMural, LocationID.BeoEglanaMural, LocationID.DeathVillageChest, LocationID.MiracleWitchChest,
    LocationID.LaMulanaChest, LocationID.LaMulana2Chest, LocationID.SacredOrbVoD, LocationID.SacredOrbChestRoY, LocationID.SacredOrbChestAnnwfn, LocationID.SacredOrbChestIB,
    LocationID.SacredOrbChestIT, LocationID.SacredOrbChestDF, LocationID.SacredOrbChestSotFG, LocationID.SacredOrbChestGotD, LocationID.SacredOrbChestTS, LocationID.SacredOrbChestHL,
    LocationID.MapChestRoY, LocationID.MapChestAnnwfn, LocationID.MapChestIB, LocationID.MapChestIT, LocationID.MapChestDF, LocationID.MapChestSotFG,
    LocationID.MapChestGotD, LocationID.MapChestTS, LocationID.MapChestHL, LocationID.MapChestValhalla, LocationID.MapChestDLM, LocationID.MapChestAC,
    LocationID.MapChestHoM, LocationID.MapChestEPG, LocationID.MapChestEPD, LocationID.AnkhChestRoY, LocationID.AnkhChestDF, LocationID.AnkhChestIT,
    LocationID.AnkhChestSotFG, LocationID.AnkhChestDLM, LocationID.AnkhChestAC, LocationID.AnkhJewel, LocationID.CrystalSkullChestRoY, LocationID.CrystalSkullChestAnnwfn,
    LocationID.CrystalSkullIB, LocationID.CrystalSkullChestIT, LocationID.CrystalSkullChestValhalla, LocationID.CrystalSkullChestGotD, LocationID.CrystalSkullChestTS, LocationID.CrystalSkullChestDLM,
    LocationID.CrystalSkullChestAC, LocationID.CrystalSkullChestHL, LocationID.CrystalSkullChestHoM, LocationID.CrystalSkullChestEPD, LocationID.ChainWhipPuzzleReward, LocationID.FlailWhipPuzzleReward,
    LocationID.SilverShieldPuzzleReward, LocationID.HeavenMantraMural, LocationID.EarthMantraMural, LocationID.SunMantraMural, LocationID.MoonMantraMural, LocationID.SeaMantraMural,
    LocationID.FireMantraMural, LocationID.WindMantraMural, LocationID.MotherMantraMural, LocationID.ChildMantraMural, LocationID.NightMantraMural, LocationID.ResearchAnnwfn,
    LocationID.ResearchIT, LocationID.ResearchIBTopLeft, LocationID.ResearchIBTopRight, LocationID.ResearchIBLeft, LocationID.ResearchIBPit, LocationID.ResearchIBTent1,
    LocationID.ResearchIBTent2, LocationID.ResearchIBTent3, LocationID.ResearchDSLM, LocationID.DissonanceValhalla, LocationID.DissonanceDSLM, LocationID.DissonanceHL,
    LocationID.DissonanceEPG, LocationID.DissonanceNibiru, LocationID.DissonanceMoG, LocationID.AlsedanaItem, LocationID.GiltoriyoItem, LocationID.XelpudItem,
    LocationID.NeburItem, LocationID.FreyasItem, LocationID.FobosItem, LocationID.FobosItem2, LocationID.MulbrukItem, LocationID.OsirisItem,
    LocationID.NeburShop1, LocationID.NeburShop2, LocationID.NeburShop3, LocationID.ModroShop1, LocationID.ModroShop2, LocationID.ModroShop3,
    LocationID.SidroShop1, LocationID.SidroShop2, LocationID.SidroShop3, LocationID.HinerShop1, LocationID.HinerShop2, LocationID.HinerShop3,
    LocationID.HinerShop4, LocationID.KorobockShop1, LocationID.KorobockShop2, LocationID.KorobockShop3, LocationID.ShuhokaShop1, LocationID.ShuhokaShop2,
    LocationID.ShuhokaShop3, LocationID.PymShop1, LocationID.PymShop2, LocationID.PymShop3, LocationID.BTKShop1, LocationID.BTKShop2,
    LocationID.BTKShop3, LocationID.MinoShop1, LocationID.MinoShop2, LocationID.MinoShop3, LocationID.BargainDuckShop1, LocationID.BargainDuckShop2,
    LocationID.BargainDuckShop3, LocationID.VenumShop1, LocationID.VenumShop2, LocationID.VenumShop3, LocationID.PeibalusaShop1, LocationID.PeibalusaShop2,
    LocationID.PeibalusaShop3, LocationID.HiroRoderickShop1, LocationID.HiroRoderickShop2, LocationID.HiroRoderickShop3, LocationID.HydlitShop1, LocationID.HydlitShop2,
    LocationID.HydlitShop3, LocationID.AytumShop1, LocationID.AytumShop2, LocationID.AytumShop3, LocationID.KeroShop1, LocationID.KeroShop2,
    LocationID.KeroShop3, LocationID.AshGeenShop1, LocationID.AshGeenShop2, LocationID.AshGeenShop3, LocationID.FairylanShop1, LocationID.FairylanShop2,
    LocationID.FairylanShop3, LocationID.MegarockShop1, LocationID.MegarockShop2, LocationID.MegarockShop3, LocationID.Ratatoskr1, LocationID.Nidhogg,
    LocationID.Kaliya, LocationID.Ixtab, LocationID.Cetus, LocationID.Ratatoskr2, LocationID.Svipdagr, LocationID.Vedfolnir,
    LocationID.Ratatoskr3, LocationID.Vidofnir, LocationID.HuginandMunin, LocationID.BadhbhCath, LocationID.Fenrir, LocationID.Balor,
    LocationID.Tezcatlipoca, LocationID.Unicorn, LocationID.RaijinandFujin, LocationID.Daji, LocationID.Belial, LocationID.Arachne,
    LocationID.Scylla, LocationID.GlasyaLabolas, LocationID.Griffin, LocationID.VucubCaquix, LocationID.Jalandhara, LocationID.Sekhmet,
    LocationID.AngraMainyu, LocationID.Ammit, LocationID.Kisikillillake, LocationID.Anzu, LocationID.HoMLeftPath, LocationID.HoMMiddlePath,
    LocationID.HoMRightPath, LocationID.Hraesvelgr, LocationID.Ratatoskr4, LocationID.Heimdall, LocationID.Fafnir, LocationID.Kujata,
    LocationID.Jormungand, LocationID.Surtr, LocationID.Vritra, LocationID.AtenRa, LocationID.Anu, LocationID.Echidna,
    LocationID.Hel, LocationID.NinthChild, LocationID.WeaponFairy, LocationID.MoneyFairy, LocationID.KeyFairy, LocationID.AnnwfnRightShortcut,
    LocationID.IBLeftShortcut, LocationID.HoMLadder, LocationID.Bergelmir, LocationID.WhitePedestals, LocationID.GarmStatuePuzzle, LocationID.SakitPuzzle,
})
...
FILLER_ITEM_IDS = {
    ...
    ItemID.ChestWeight03,
    ItemID.ChestWeight04,
    ItemID.ChestWeight05,
    ItemID.ChestWeight06,
    ItemID.ChestWeight07,
    ItemID.ChestWeight08,
    ItemID.ChestWeight09,
    ItemID.ChestWeight10,
    ItemID.ChestWeight11,
    ItemID.ChestWeight12,
    ItemID.ChestWeight13,
    ItemID.ChestWeight14,
    ItemID.ChestWeight15,
    ItemID.ChestWeight16,
    ItemID.ChestWeight17,
    ItemID.ChestWeight18,
    ItemID.ChestWeight19,
    ItemID.ChestWeight20,
    ItemID.ChestWeight21,
    ItemID.ChestWeight22,
    ItemID.ChestWeight23,
    ItemID.ChestWeight24,
    ItemID.ChestWeight25,
    ItemID.ChestWeight26,
    ItemID.ChestWeight27,
    ItemID.ChestWeight28,
    ItemID.ChestWeight29,
    ItemID.ChestWeight30,
    ItemID.ChestWeight31,
    ItemID.ChestWeight32,
    ItemID.ChestWeight33,
    ItemID.ChestWeight34,
    ItemID.ChestWeight35,
    ItemID.ChestWeight36,
    ItemID.ChestWeight37,
...
GUARDIAN_ANKHS_ITEMS: dict = {
    ...
    ItemID.AnkhJewel2: "Ankh Jewel (Vritra)",
    ItemID.AnkhJewel3: "Ankh Jewel (Kujata)",
    ItemID.AnkhJewel4: "Ankh Jewel (Aten-Ra)",
    ItemID.AnkhJewel5: "Ankh Jewel (Jormungand)",
    ItemID.AnkhJewel6: "Ankh Jewel (Anu)",
    ItemID.AnkhJewel7: "Ankh Jewel (Surtr)",
    ItemID.AnkhJewel8: "Ankh Jewel (Echidna)",
    ItemID.AnkhJewel9: "Ankh Jewel (Hel)",
}
GUARDIAN_ANKHS_LOCATIONS: dict = {
    LocationID.Fafnir:     "Ankh Jewel (Fafnir)",
    LocationID.Vritra:     "Ankh Jewel (Vritra)",
    LocationID.Kujata:     "Ankh Jewel (Kujata)",
    LocationID.AtenRa:     "Ankh Jewel (Aten-Ra)",
    LocationID.Jormungand: "Ankh Jewel (Jormungand)",
    LocationID.Anu:        "Ankh Jewel (Anu)",
    LocationID.Surtr:      "Ankh Jewel (Surtr)",
    LocationID.Echidna:    "Ankh Jewel (Echidna)",
    LocationID.Hel:        "Ankh Jewel (Hel)",
}
LOGIC_FLAG_LOCATION_IDS = {
    # Minibosses
    LocationID.Ratatoskr1: "Ratatoskr 1",
    LocationID.Nidhogg: "Nidhogg",
    LocationID.Kaliya: "Kaliya",
    LocationID.Ixtab: "Ixtab",
    LocationID.Cetus: "Cetus",
    LocationID.Ratatoskr2: "Ratatoskr 2",
    LocationID.Svipdagr: "Svipdagr",
    LocationID.Vedfolnir: "Vedfolnir",
    LocationID.Ratatoskr3: "Ratatoskr 3",
    LocationID.Vidofnir: "Vidofnir",
    LocationID.HuginandMunin: "Hugin and Munin",
    LocationID.BadhbhCath: "Badhbh Cath",
    LocationID.Fenrir: "Fenrir",
    LocationID.Balor: "Balor",
    LocationID.Tezcatlipoca: "Tezcatlipoca",
    LocationID.Unicorn: "Unicorn",
    LocationID.RaijinandFujin: "Raijin and Fujin",
    LocationID.Daji: "Daji",
    LocationID.Belial: "Belial",
    LocationID.Arachne: "Arachne",
    ...
    LocationID.Ammit: "Ammit",
    LocationID.Kisikillillake: "Ki sikil lil la ke",
    LocationID.Anzu: "Anzu",
    LocationID.HoMLeftPath: "HoM Left Path",
    LocationID.HoMMiddlePath: "HoM Middle Path",
    LocationID.HoMRightPath: "HoM Right Path",
    LocationID.Orthrus: "Orthrus",
    LocationID.Hraesvelgr: "Hraesvelgr",
    LocationID.Ratatoskr4: "Ratatoskr 4",
    LocationID.Heimdall: "Heimdall",

    # Bosses
    LocationID.Fafnir: "Fafnir",
    LocationID.Kujata: "Kujata",
    LocationID.Jormungand: "Jormungand",
    LocationID.Surtr: "Surtr",
    LocationID.Vritra: "Vritra",
    LocationID.AtenRa: "Aten Ra",
    LocationID.Anu: "Anu",
    LocationID.Echidna: "Echidna",
    LocationID.Hel: "Hel",
    LocationID.NinthChild: "Ninth Child",

    # Dissonance Logic
    # LocationID.DissonanceValhalla: "Dissonance",
    # LocationID.DissonanceDSLM: "Dissonance",
    # LocationID.DissonanceHL: "Dissonance",
    # LocationID.DissonanceEPG: "Dissonance",
    # LocationID.DissonanceNibiru: "Dissonance",
    # LocationID.DissonanceMoG: "Dissonance",

    # Fairies
    LocationID.WeaponFairy: "Weapon Fairy",
    LocationID.MoneyFairy: "Money Fairy",
    LocationID.KeyFairy: "Key Fairy",
        
    # Puzzles
    LocationID.AnnwfnRightShortcut: "Annwfn Right Shortcut",
    LocationID.IBLeftShortcut: "IB Left Shortcut",
    LocationID.HoMLadder: "HoM Ladder",
    LocationID.Bergelmir: "Bergelmir",
...
LOGIC_FLAG_ITEM_IDS = {
    ...
    ItemID.Ratatoskr3,
    ItemID.Vidofnir,
    ItemID.HuginandMunin,
    ItemID.BadhbhCath,
    ItemID.Fenrir,
    ItemID.Balor,
    ItemID.Tezcatlipoca,
    ItemID.Unicorn,
    ItemID.RaijinandFujin,
    ItemID.Daji,
    ItemID.Belial,
    ItemID.Arachne,
    ItemID.Scylla,
    ...
    ItemID.AngraMainyu,
    ItemID.Ammit,
    ItemID.Kisikillillake,
    ItemID.Anzu,
    ItemID.HoMLeftPath,
    ItemID.HoMMiddlePath,
    ItemID.HoMRightPath,
    ItemID.Hraesvelgr,
    ItemID.Ratatoskr4,
    ItemID.Heimdall,
    ...
    # Puzzles
    ItemID.AnnwfnRightShortcut,
    ItemID.IBLeftShortcut,
    ItemID.HoMLadder,
    ItemID.Bergelmir,
...
LOGIC_FLAG_MAP = {
    "Ratatoskr 1": ItemID.Ratatoskr1,
    "Nidhogg": ItemID.Nidhogg,
    "Kaliya": ItemID.Kaliya,
    "Ixtab": ItemID.Ixtab,
    "Cetus": ItemID.Cetus,
    "Ratatoskr 2": ItemID.Ratatoskr2,
    "Svipdagr": ItemID.Svipdagr,
    "Vedfolnir": ItemID.Vedfolnir,
    "Ratatoskr 3": ItemID.Ratatoskr3,
    "Vidofnir": ItemID.Vidofnir,
    "Hugin and Munin": ItemID.HuginandMunin,
    "Badhbh Cath": ItemID.BadhbhCath,
    "Fenrir": ItemID.Fenrir,
    "Balor": ItemID.Balor,
    "Tezcatlipoca": ItemID.Tezcatlipoca,
    "Unicorn": ItemID.Unicorn,
    "Raijin and Fujin": ItemID.RaijinandFujin,
    "Daji": ItemID.Daji,
    "Belial": ItemID.Belial,
    "Arachne": ItemID.Arachne,
    ...
    "Ammit": ItemID.Ammit,
    "Ki sikil lil la ke": ItemID.Kisikillillake,
    "Anzu": ItemID.Anzu,
    "HoM Left Path": ItemID.HoMLeftPath,
    "HoM Middle Path": ItemID.HoMMiddlePath,
    "HoM Right Path": ItemID.HoMRightPath,
    "Hraesvelgr": ItemID.Hraesvelgr,
    "Ratatoskr 4": ItemID.Ratatoskr4,
    "Heimdall": ItemID.Heimdall,

    # Bosses
    "Fafnir": ItemID.Fafnir,
    "Kujata": ItemID.Kujata,
    "Jormungand": ItemID.Jormungand,
    "Surtr": ItemID.Surtr,
    "Vritra": ItemID.Vritra,
    "Aten Ra": ItemID.AtenRa,
    "Anu": ItemID.Anu,
    "Echidna": ItemID.Echidna,
    "Hel": ItemID.Hel,
    "Ninth Child": ItemID.NinthChild,

    # Fairies
    "Weapon Fairy": ItemID.WeaponFairy,
    "Money Fairy": ItemID.MoneyFairy,
    "Key Fairy": ItemID.KeyFairy,

    # Dissonance
    "Dissonance": ItemID.Dissonance,
        
    # Puzzles
    "Annwfn Right Shortcut": ItemID.AnnwfnRightShortcut,
    "IB Left Shortcut": ItemID.IBLeftShortcut,
    "HoM Ladder": ItemID.HoMLadder,
    "Bergelmir": ItemID.Bergelmir,
...
ORIGINAL_SHOP_ITEMS = {
    ...
    ItemID.Snapshot,
    ItemID.EngaMusica, 
    ItemID.LonelyHouseMoving, 
    ItemID.FutureDevelopmentCompany,
    ItemID.SpaceCapstarII, 
    ItemID.RaceScanner, 
    ItemID.Harp, 
    ItemID.GaneshaTalisman,
    ItemID.BounceShot, 
    ItemID.RoseandCamelia, 
    ItemID.MekuriMaster, 
    ItemID.Shield3,
    ItemID.Bracelet
}
ORIGINAL_SHOP_PRICES = {
    # Format: ItemID: price_multiplier
    ItemID.Weights: 5,
    ItemID.YagooMapReader: 5,
    ItemID.TextTrax: 7,
    ItemID.Pepper: 9,
    ItemID.ShurikenAmmo: 10,
    ItemID.RollingShurikenAmmo: 10,
    ItemID.EarthSpearAmmo: 10,
    ItemID.FlareAmmo: 10,
    ItemID.BombAmmo: 10,
    ItemID.ChakramAmmo: 10,
    ItemID.CaltropsAmmo: 10,
...
def get_item_name_from_id(item_id: ItemID) -> str:
    ...
    # For other items, convert enum name to display name
    for name, member in ItemID.__members__.items():
        if member == item_id:
            # Remove trailing underscore from "None_"
            if name.endswith('_'):
                name = name[:-1]
    ...
    raise ValueError(f"No item name found for ItemID {item_id}")